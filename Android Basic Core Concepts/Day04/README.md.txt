...
> ← [Day 03 — Intents](./Day-03-Android-Intents.md)
...
- [ ] Day 05 — Fragments (sub-screens within one Activity)
- [ ] Day 06 — RecyclerView (scrollable lists)
- [ ] Day 07 — Navigation Component (Jetpack way to manage screens)

---

> **Previous:** [Day 03 — Intents](./Day-03-Android-Intents.md)
